...
| 平台 | 下载文件 | 架构 |
|------|----------|------|
| macOS | `Vibe.Reader-0.2.6-arm64.dmg` 或 `.zip` | Apple Silicon (M1/M2/M3/M4) |
| Windows | `Vibe.Reader.Setup.0.2.6.exe` | x64 |
| Linux | `Vibe.Reader-0.2.6.AppImage` 或 `vibe-reader_0.2.6_amd64.deb` | x64 |
